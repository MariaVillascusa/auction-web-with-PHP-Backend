...
<head>
    ...
    <div class="container-xxl" id="product-container">
        <div class="row" id="row-top">
            ...
            <div class="col-4 bg" id="div-bids">
                ...
                <div class="row" id="d-fast">
                    <h6>Puja rápida</h6>
                    <div id='buttons'>
                        <button class="bttn click bid-btn" id="btn1">Bid1</button>
                        <button class="bttn click bid-btn" id="btn2">Bid2</button>
                        <button class="bttn click bid-btn" id="btn3">Bid3</button>
                    </div>
                </div>
